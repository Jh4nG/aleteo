        ...
        readAnimation: function(a, b, d) {
            ...
            if (eb) {
                for (var m = new c.EventTimeline(eb.length), n = 0, o = 0, p = eb.length; p > o; o++) {
                    ...
                    if (!gb)
                        throw "Event not found: " + fb.name;
                    var hb = new c.Event(gb);
                    hb.intValue = fb.hasOwnProperty("int") ? fb["int"] : gb.intValue,
                    hb.floatValue = fb.hasOwnProperty("float") ? fb["float"] : gb.floatValue,
                    hb.stringValue = fb.hasOwnProperty("string") ? fb.string : gb.stringValue,
