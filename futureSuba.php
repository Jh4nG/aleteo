...
<link href="layout/styles/futureSuba.css?v=4" rel="stylesheet" type="text/css" media="all">
    
    <div style="margin-top:50px;"></div>
    <body id="top" class="bgded imgFirts">

        <?php include 'componentes/componenteParticulasFSV2.html'; ?>

        <div class="container">
            <div class="col-12">
                <div class="row">
                    <!-- Sección Artístas -->
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 divSectionPrincipal divArtistas animate__animated animate__fadeInTopLeft animate__delay-2s">
                        <div class="card pointer" data-view="Artistas">
                    ...
                    <!-- Fin Sección Artístas -->

                    <!-- Sección 360 -->
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 divSectionPrincipal div360 animate__animated animate__fadeInTopRight animate__delay-2s">
                        <div class="pointer card-iframe" data-view="360">
                            <iframe class="iframe" width="100%" src="componentes/panorama.php?id=0"></iframe>
                            <span class="iconView360" data-toggle="tooltip" data-placement="top" title="Ver Imágenes"><i class="fa fa-eye"></i></span>
                        </div>
                    </div>
                    <!-- Fin Sección 360 -->

                     <!-- Sección Podcast -->
                     <div class="col-12 col-sm-12 col-md-6 col-lg-6 divSectionPrincipal divPodcast  animate__animated animate__fadeInBottomLeft animate__delay-2s">
                        <div class="main pointer" data-view="Podcast">
                            <div class="card">
                                <div class="ups">
                    ...
                    <!-- Sección Voces -->
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 divSectionPrincipal divVoces animate__animated animate__fadeInBottomRight animate__delay-2s">
                        <div class="card pointer" data-view="Voces">
                            <div class="card-info">
        ...
        <div class="col-md-12 col-sm-12" align="center">
            ...
            <div class="col-md-6 cssComentarios" style="max-height: 470px;" align="left">
                ...
                <br>
                <button class="btn btn-primary pull-right" id="btnComentarioPodcast" onclick="_SubaFuturo.ingresarComent()">Comentar</button>
                <br><br>
        ...
        <div class="modal fade " id="modal-view-future" role="dialog">
            <div class="modal-dialog modal-lg" id="modal-large-dialog" style="max-width: 1200px;">
                ...
                <div class="modal-content bgDarkModal ModalBlue">
                    ...
                    <div id="modal-body-lg-future" class="modal-body">
                        <!-- Sección Artistas Modal -->
                        <div class="divArtistasModal hidden">
                            <div class="divArtistasModalMapa d-none d-sm-block">
                                <img class="glitch__title_img" src="./images/img-project/futureSuba/piezaArtistas.png" width="100%" style="filter: sepia(1);" />
                                <h1 class="glitch__title title_firts" style="position: fixed; top: 14%; left: 32%;">Mapa Museo Itinerante: </h1>
                                <h1 class="glitch__title title_second" style="position: fixed; top: 19%; left: 29%;">Suba aletea hacia el futuro</h1>
                            </div>
                            <div class="divArtistasModalIcono d-block d-sm-none"></div>
                        </div>
                        <!-- Sección 360 Modal -->
                        <div class="div360Modal hidden"></div>
                        <!-- Sección Podcast Modal -->
                        <div class="divPodcastModal hidden"></div>
                        <!-- Sección Voces Modal -->
                        <div class="divVocesModal hidden"></div>
                    </div>
                </div>
        ...
        <div class="modal fade " id="modal-view-future-360" role="dialog">
            <div class="modal-dialog modal-lg" id="modal-large-dialog-360" style="max-width: 1200px;">
                <!-- Modal content-->
                <div class="modal-content bgDarkModal ModalBlue">
                    <div class="modal-header">
                        <h4 id="modal-title-lg-360" class="modal-title"></h4>
                        <button type="button" class="closeBg" data-dismiss="modal">&times;</button>
                    </div>
                    <div id="modal-body-lg-future-360" class="modal-body"></div>
                </div>
            </div>
        </div>

        <div class="modal fade " id="modal-view-future-Artistas" role="dialog">
            <div class="modal-dialog modal-lg" id="modal-large-dialog-Artistas" style="max-width: 1200px;">
                <!-- Modal content-->
                <div class="modal-content bgDarkModal ModalBlue">
                    <div class="modal-header">
                        <h4 id="modal-title-lg-Artistas" class="modal-title"></h4>
                        <button type="button" class="closeBg" data-dismiss="modal">&times;</button>
                    </div>
                    <div id="modal-body-lg-future-Artistas" class="modal-body">
                        <div class="row">
                            <div class="col-sm-12 col-md-8" id="divUrlArtistas"></div>
                            <div class="col-sm-12 col-md-4" id="divTextoArtistas"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade " id="modal-view-future-video-principal" role="dialog">
            <div class="modal-dialog modal-lg" id="modal-large-dialog-video-principal" style="max-width: 1200px;">
                <!-- Modal content-->
                <div class="modal-content bgDarkModal ModalBlue">
                    <div class="modal-header">
                        <h4 id="modal-title-lg-video-principal" class="modal-title"></h4>
                        <button type="button" class="closeBg" data-dismiss="modal">&times;</button>
                    </div>
                    <div id="modal-body-lg-future-video-principal" class="modal-body"></div>
                </div>
            </div>
        </div>
        ...
        <footer>
            ...
            <div class="footer-future-suba">
                <img src="./images/img-project/futureSuba/cultura.png" />
                <img src="./images/img-project/futureSuba/footer.png?v=3" />
            </div>
        </footer>
